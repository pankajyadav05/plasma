    ...
    <Popover open={!!detail} onOpenChange={onOpenChange}>
      ...
      >
        <div className="flex items-baseline justify-between gap-3 border-b px-4 py-3">
          ...
          <Button variant="ghost" size="icon-xs" onClick={handleCopy} aria-label="Copy value" title="Copy">
        ...
        <div className="max-h-[360px] overflow-auto bg-muted/40 p-3">
          {detail?.value === null || detail?.value === undefined ? (
            ...
            <span className="font-display text-sm italic text-muted-foreground">(empty string)</span>
          ) : (
            <pre
              className={
                isMultiline
